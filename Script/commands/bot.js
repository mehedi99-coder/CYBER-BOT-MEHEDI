...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Mehedi") || (event.body.toLowerCase() == "@Mehedi Hasan") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
  ...
  if ((event.body.toLowerCase() == "@Rabbi Ahmed ") || (event.body.toLowerCase() == "রাব্বি")) {
   ...
   if ((event.body.toLowerCase() == "tmi ki amke vlobasho") || (event.body.toLowerCase() == "tmi ki amake vlobasho")) {
